...
public class KimiGradingService {
    ...
    public GradingResult gradeQuestion(Question question, String userAnswer, int maxScore) {
        try {
    ...
    private String buildGradingPrompt(Question question, String userAnswer, int maxScore) {
